							...
							<div class="row">	
								<div class="form-group col-lg-6" id="incomedate">
									...
									<div  class="input-group date" data-date-format="mm-dd-yyyy">
										...
										<input id="idate" {{Auth::user()->role !='Administrator'?"disabled":"enabled"}} class="form-control" type="text" value="<?php echo date("Y-m-d");?>"/>
				...
				<div class="card">
							...
							<div class="row">	
								<div class="form-group col-lg-6" id="expensedate">
									...
									<small class="req text-danger">* </small><?php echo trans('lang.date');?></label>
									<div  class="input-group date" data-date-format="mm-dd-yyyy">
										<input id="edate" {{Auth::user()->role !='Administrator'?"disabled":"enabled"}} class="form-control" type="text" value="<?php echo date("Y-m-d");?>"/>
										<span class="input-group-addon" style="border: 1px solid #cecece;"><i class="fa fa-calendar"></i></span>
									</div>
								</div>
								<div class="form-group col-lg-6">
...
$(document).ready(function() {
	...
	// get account for staff user
	$.ajax({
        type: "GET",
        url: "{{ url('/transaction/getAccountFroTransaction')}}",
        dataType: "json",
        data: "{}",
        success: function (html) {
			var objs = html;
