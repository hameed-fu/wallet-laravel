...
<div class="content">
			...
			<div class="col-md-5">
                <div class="card">
                    ...
                    <div class="content">
						...
						<!--<div class="col-md-12">
							<div class="row" id="categorybalance">
								<div class="col-md-8">
									<h6>Category name</h6>
								</div>
								<div class="col-md-4">
		...
		<div class="row">
			<div class="col-md-4">
                <div class="card">
                    <div class="header">
                        <h5 class="title"><?php echo trans('lang.expense_by_category').' '.date("F Y");?><h5>
			...
			<div class="col-md-4">
                <div class="card">
                    <div class="header">
                        <h5 class="title"><?php echo trans('lang.income_by_category').' '.date("F Y");?><h5>
			...
			<div class="col-md-4">
                ...
                <div class="card">
                    <div class="header">
                        <h5 class="title"><?php echo trans('lang.budget').' '.date("F Y");?><h5>
