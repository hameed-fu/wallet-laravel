...
Route::get('/account/transfer_history/{accountid}','AccountController@getAllTranferHistory');
Route::get('/account/getAllTranferTransaction/{accountid}','AccountController@getAllTranferTransaction');
Route::get('/account/getAllTranferTransactionForBalance/{accountid}','AccountController@getAllTranferTransactionForBalance');
...
Route::get('/transaction/getAccountFroTransaction','IncomeTransactionController@getAccountFroTransaction');
